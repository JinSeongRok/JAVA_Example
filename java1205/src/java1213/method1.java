...
class Area{
	static void manual() {		// static 클래스 메서드 : void 리턴 값이없다.
	...
	int retangle(int a, int b) {			// 사각형 넓이 구하는 메서드 : 인스턴스 메서드 선언
		return a * b;
	}
...
public class method1 {
	...
	public static void main(String[] args) {
		...
		//Area.retangle(3, 4);		//인스턴스 메서드 접근 불가능 <- 인스턴스 생성전
		
		Area cal = new Area();	//인스턴스 cal 생성 calculator
		
		cal.manual();
		System.out.println(cal.triangle(3, 5));
		System.out.println(cal.retangle(3, 4));
